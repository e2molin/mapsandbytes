...
import imgLocarnoBaveno from "./image/locarno-Baveno.jpg";
import imgVerbaniaLungoLago from "./image/lungolago-verbania.jpg";
import imgIsolaMaggiore from "./image/isola-maggiore.jpg";
import imgArona from "./image/arona.jpg";
import imgIsolaGuilio from "./image/isola-giulio.jpeg";
import imgCascataToce from "./image/cascada-toce-2.jpg";
import imgFormazzaTunel from "./image/formazza-tune-espiral.jpg";
import imgMacugnaga from "./image/macugnaga.jpg";
import imgMergozzo from "./image/mergozzo-description.webp";
import imgMottarone from "./image/view-from-vetta-di-mottarone.jpg";
import imgTorinoPanorama from "./image/panoramica-torino.jpg";
import imgPalazzoReale from "./image/palazzo-reale.jpg";
import imgMuseoEgizio from "./image/museo-egizio.jpg";
import imgMonumentoDiablo from "./image/munumeno-diablo.jpg";
import imgGranMadre from "./image/gran-madre-dio.jpg";
import imgBorgoMedievale from "./image/borgo-medievale.jpg";
import imgSanMichelle from "./image/sacra-san-michelle.jpg";
import imgLingotto01 from "./image/lingotto-01.jpg";
import imgLingotto02 from "./image/lingotto-02.jpg";
import imgArles from "./image/arles-guided-tour.webp";
import imgSuperga from "./image/superga_destination.webp";
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgLocarnoBaveno} />
    <figcaption> Locarno - Baveno -  🚗[Itinerario](https://maps.app.goo.gl/XmWfEFkRyuVWLcGs5) </figcaption>
  </figure>
</section>

Verbania es una de las localidades más importantes, tiene un gran paseo a la orilla del lago con parques y mercadillos de verano. Numerosas terrazas para cenar.

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgVerbaniaLungoLago} />
    <figcaption> Verbania - Lungolago di Pallanza -  📍[Posición](https://maps.app.goo.gl/X83hdaBhCGMfX5tLA) </figcaption>
  </figure>
</section>


Para dormir, cualquier localidad está bien. Quizás cuanto más al sur ya alejado de Suiza, más barato. Baveno y Stressa están bien. De todas estas localidades costeras salen ferris para conocer las *«ísolas»* del lago, recomendable cogerlos barcos en Baveno. Los ferris hacen rutas circulares en plan autobús. Coges uno, bajas en una isla, la visitas, y cuando terminas esperas al siguiente. Las rutas son circulares y siempre puedes volver al sitio del que saliste. Las islas son *«Isola dei Pescatori»* e *«Isola Bella»*. Yo os recomiendo el de Baveno, menos gente, parking al lado 📍[Posición](https://maps.app.goo.gl/sVkZdeUsM2Bh9aETA).

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgIsolaMaggiore} />
    <figcaption> Islas en el Lago Maggiore </figcaption>
  </figure>
</section>


La localidad de **Arona** es la más importante al sur del lago Maggiore. Mejor visitarla al final o para pasar la última noche antes de seguir camino. Aquí os recomiendo el restaurante Barcaiolo Restaurant 📍[posición](https://maps.app.goo.gl/emKUArtwLMqJ1K8A8) para cenar una pasta y un pescado de calidad. La plaza porticada donde está el restaurante es fantástica para ver la puesta del. Si no se puede cenar, sentarse en la orilla a tomar un gelato 🍨.

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgArona} />
    <figcaption> Arona 📍[Posición](https://maps.app.goo.gl/emKUArtwLMqJ1K8A8)</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgIsolaGuilio} />
    <figcaption> Isola de Giulio 📍[Posición](https://maps.app.goo.gl/EXdm2bYC5681aQ95A)</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgCascataToce} />
    <figcaption> Cascata del Toce - Formazza</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgFormazzaTunel} />
    <figcaption> Tunel espiral -  Valle de Formazza</figcaption>
  </figure>
</section>

* Una opción más desde Baveno, también alpina, el pueblo de **Macugnaga** 🚗[esta es la ruta](https://maps.app.goo.gl/kZtazNTFZ5obDBA68), que está a solo 60 Km. Desde este pueblo sacado de una postal se ve el Monte Rosa o DufourSpitze para los suizos. Al atardecer la luz del sol lo ilumina del color de su nombre. Si se llega pronto se puede subir hasta las cumbres en teleférico y bajar andando. Un buen sitio para comer aquí [es este restaurante](https://maps.app.goo.gl/4CFaLwnTSh7KZvRAA)

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgMacugnaga} />
    <figcaption> Macugnaga y Monte Rossa</figcaption>
  </figure>
</section>

En **Macugnaga** hay un restaurante en la montaña llamado 🍽️[Ristoro Paradiso](https://maps.app.goo.gl/6ecrKAR8MwmEbEgS6). Para llegar en invierno hay que ir en moto de nieve (está incluido en el precio de la reserva). No sé si en verano tendrá servicio, pero comer allí unos *«tagliatelle con ragú»* o una *«polenta con funghi»* merecen buscar la manera de llegar.
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgMergozzo} />
    <figcaption> Mergozzo junto a su lago</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgMottarone} />
    <figcaption> Vistas desde lo alto del Mottarone</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgTorinoPanorama} />
    <figcaption> Torino desde Monte dei Cappuccini 📍[Posición](https://maps.app.goo.gl/RuPpAo397uBvXQK3A)</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgPalazzoReale} />
    <figcaption> Palacio real desde la Piazza del Castello</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgMuseoEgizio} />
    <figcaption> Museo Egizio - Sala de las esfinges</figcaption>
  </figure>
</section>

* Si vamos hacia el oeste, también por calles comerciales vamos hasta la Piazza Statutom, con una de las fuentes que algunos identifican con el monumento al diablo, **Monumento al Traforo del Cenisio-Frejus**. Por aquí también se encuentra la **Porta Palazzo**, donde suele haber un mercadillo estilo El rastro madrileño muy interesante de visitar.

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgMonumentoDiablo} />
    <figcaption> Traforo del Cenisio-Frejus</figcaption>
  </figure>
</section>

* Si salimos al este, podemos pasar a ver y subir a la **Mole Antonelliana** y bajar hasta el Po. Cruzando el punte, la **Gran Madre de Dio**, una iglesia que según la tradición está vigilante de la sombra del diablo.

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgGranMadre} />
    <figcaption> Chiesa della Gran Madre di Dio</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgBorgoMedievale} />
    <figcaption> Borgo Medievale</figcaption>
  </figure>
</section>
...
* Subir en funicular a la **Basílica de Superga**. Se llega en coche hasta la 🚉[Stazione Sassi](https://maps.app.goo.gl/aAkcQJpxVwAdZFeN7), se sube en funicular y se baja paseando ( o en funicular si vais mal de tiempo). Es la montaña donde se estrelló el avión con equipo de fútbol del Gran Torino en 1949. Iglesia y monumento con vistas estupendas.

<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgSuperga} />
    <figcaption> Basílica de Superga 📍[Posición](https://maps.app.goo.gl/zg6Br9RmYcfD7kuY8)</figcaption>
  </figure>
</section>
...
<section class="center-lanscape-section">
  <figure class="img-single">
    <img  src={imgArles} />
    <figcaption> Arènes de Arles 📍[Posición](https://maps.app.goo.gl/7DLPoiyfc6fz5jPX9)</figcaption>
  </figure>
</section>
